...
% ------------------------------------------------------------------
\section{\label{sec:mcrg}Monte Carlo Renormalization Group} % In progress
...
We use the plaquette, the three six-link loops and a planar eight-link loop to perform the matching. % DS: I thought it was the ``figure-eight'' loop, not the 2x2 plaquette
...
% ------------------------------------------------------------------
\section{\label{sec:wmcrg}Wilson Flow MCRG} % In progress
\begin{figure}[th]
  \centering
...
% ------------------------------------------------------------------
\section{\label{sec:results}Results for 12 Flavors} % In progress
\begin{figure}[ht]
  \centering
  \includegraphics[height=3 in]{fig/12flav_6-12-24_3lm.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[height=3 in]{fig/12flav_8-16-32_44_as_3lm.pdf}
...
\begin{figure}[th]
  \centering
  \includegraphics[height=3 in]{fig/12flav_8-16-32_3lm_22.pdf}
